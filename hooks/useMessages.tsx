...
import { openMessagesInbox } from '@/components/InAppNotificationProvider';
import { showPushNotification } from '@/lib/notificationBridge';
      ...
      const timer = setTimeout(async () => {
        ...
        if (promptReply) {
          showPushNotification({
            title: `${collector.collectorName} replied`,
            body: replyBody,
